    ...
    <div className={styles.content}>
      <div className={styles.contentLeft}>
        ...
        <div className={styles.contentLeftContent}>
          ...
          <div className={styles.bigButtonHolder}><a onClick={calendlyPopUp} href="#Request" className="global-button"><i className="fa fa-send-o fa-fw" aria-hidden="true"></i>Request a Demo</a></div>
