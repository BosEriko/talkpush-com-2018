        ...
        <div className={styles.blockTeam}>
          <div className="container">
            ...
            <div className={styles.blockTeamMembers}>
              ...
              <div className={styles.blockTeamMembersRow}>
                <RowItem name="Romain Verbeke" title="Head of Engineering" image={defaultPicture} description="Romain leads our software development effort. He has over 4 years of experience leading software development efforts, including one in a startup in Hong Kong. He is our resident Ruby on Rail expert and is always on the look-out for ways to make the software run better and faster." />
